            ...
            <main>
                        ...
                        <td class="cell">
                            <div>
                                <a target="_blank" href="https://site de l'ecole.com.com">
                                    <img src={{  public_path('images/institutions/'.$company_logo)}} alt="NoLOGO"
                ...
                <div class="row contacts">
                    <div class="col invoice-to">
                        ...
                        <span style="margin-right:5%;float:right;"> <b>Rest:</b>{{$rest}}</span>
                ...
                <div style="margin-left:2%">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td style="color:royalblue"> PAIEMENT DES FRAIS D'INSCRIPTION</td>
                        </tr>
                    </table>
